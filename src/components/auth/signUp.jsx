import { Box, Checkbox, Container, FilledInput, FormControl, FormControlLabel, Grid, IconButton, InputAdornment, InputLabel, OutlinedInput, Typography } from '@material-ui/core'
    ...
    return (
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <Grid container direction="column" align="center" justify="center" spacing={3} xs={12} style={{ minHeight: '100vh', margin: 0 }} >
                ...
                <Grid container item md={12} alignItems="flex-start" direction="column" alignContent="center" >
                    <Grid container item md={6} sm={8} spacing={3} direction="column">
                        ...
                        <Grid item>
                            <ThemePassword values={values} handleChange={handleChange} handleMouseDownPassword={handleMouseDownPassword} handleClickShowPassword={handleClickShowPassword} isRequired name="password" />
                        </Grid>
                        <Grid item>
